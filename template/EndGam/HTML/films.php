				...
				<div class="col-xl-7 col-lg-8 col-md-7">
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="./img/joker-affiche.jpg" alt="#">
								<h5>Joker 2</h5>
						...
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="./img/miserables.jpg" alt="#">
								<h5>Miserables</h5>
								<a href="game-single.html" class="read-more">En savoir plus  <img src="img/icons/double-arrow.png" alt="#"/></a>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="./img/ThreeKingdom.jpg" alt="#">
								<h5>ThreeKingdom</h5>
								<a href="game-single.html" class="read-more">En savoir plus  <img src="img/icons/double-arrow.png" alt="#"/></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="./img/Detroit.jpg" alt="https://www.youtube.com/watch?v=e7LkbcHPj4s">
								<h5>Detroit become human</h5>
								<a href="https://www.youtube.com/watch?v=e7LkbcHPj4s" class="read-more">En savoir plus  <img src="img/icons/double-arrow.png" alt="https://www.youtube.com/watch?v=e7LkbcHPj4s"/></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
